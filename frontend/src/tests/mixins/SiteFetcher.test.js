...
describe('site fetcher', () => {
  ...
  it('update resolves undefined on 2xx response', async () => {
    const site = {
      id: 1,
      title: 'Site 1',
      url: 'http://www.site1.com',
    };
    const siteFetcherPromise = SiteFetcher.update(site);
  ...
  it('update rejects to null on non-2xx response', async () => {
    const site = {
      id: 1,
      title: 'Site 1',
      url: 'http://www.site1.com',
  ...
  it('update rejects on network errors', () => {
    // TODO how to test fetch network errors?
  });
});
